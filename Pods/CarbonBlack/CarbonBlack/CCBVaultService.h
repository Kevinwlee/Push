...
/** 
 If you need to store data AND resources in the Carbon Vault, you will need to pass the data and an array of CCBVaultResource objects for the files that you want uploaded.
 @param item the NSDictionary representation of the item you want to persist.
...
/**
 Save an object that implements the CCBVaultItem protocol in the Carbon Vault.
...
/**
 Update an object that implements the CCBVaultItem protocol in the Carbon Vault.
...
/**
 Delete an object that implements the CCBVaultItem protocol from the Carbon Vault.
 @warning Your object must have maintain the vaultInfo property.
 @param item the CCBVault item that you want to persist.
 @param completionBlock executed after the create operation has completed on the server.
 */
