...
/** 
 Used to get CLCircularRegions (geofences) from the carbon api.
 */
@interface CCBGeofenceService : CLCircularRegion

/** 
 get geofences from carbon api
...
/**
 get geofences from carbon api that are near the current location.
 @param success executed when the network request completes without errors.  The success param is passed an array of CLCircularRegions.
 @param failure executed when the network request fails.  The session and error are passed to the failure block.
 */
...
/**
used to create geofence on the carbon server.
...
/**
 used to delete a geofence on the carbon server.
...
/**
 used to update a geofence on the carbon server.
