...
/**
 low level proxy that wraps the ContextHub push api.
 */
@interface CCHNotificationProxy : NSObject
...
/**
 * Request a notification to be sent from ContextHub
...
/**
 * Request an APNS notification to be sent from ContextHub
 * @param params Dictionary of parameters for request
 * @param success Block called on successful request. Takes a response dictionary
 * @param failure Block called on failed request. Takes an error for the failure.
 */
...
/**
 * Request a GCM notification to be sent from ContextHub
 * @param params Dictionary of parameters for request
 * @param success Block called on successful request. Takes a response dictionary
 * @param failure Block called on failed request. Takes an error for the failure.
 */
